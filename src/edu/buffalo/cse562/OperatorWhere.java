...
public class OperatorWhere{
    ...
    /*
     * Function to replace values from tuple in the expression.

     * For example:
     * 
     * Tuple: ABDELAL01|Alaa|Abdelnaby|1990|1994|240|1968-06-24
     *  
     *  Expression: FIRSTSEASON >= 1980 AND FIRSTSEASON < 1991 
     *
     *
     *   result: 1990 >= 1980 AND 1990 < 1991
     */
    ...
    public String createExpression(List<Tuple> instream)
    {
        ...
        for(String s : colnames){
            ...
            for(Tuple t : instream){
                ...
                if(val!=null){
                    if(checkDate(val)){
                        condition=condition.replaceAll("\\bDATE\\b","{d").replace("(","").replace(")","}");
